...
class GlobalAvoidance(RoboticPatterns):
    """Always avoid"""
...
class TriggerRoboticPatterns(RoboticPatterns):

    def __init__(self, formula: str, variables: Variables):
        super().__init__(formula, variables)


class DelayedReaction(TriggerRoboticPatterns):
...
class InstantReaction(RoboticPatterns):
...
class PromptReaction(RoboticPatterns):
...
class BoundReaction(RoboticPatterns):
...
class BoundDelay(RoboticPatterns):
...
class Wait(TriggerRoboticPatterns):
