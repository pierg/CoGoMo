...
from old_src.goals import create_contextual_clusters, mapping, create_cgt, \
    pretty_cgt_exception
from tools.strings_manipulation import save_to_file
from mapping_specification import get_inputs
from old_src.typescogomo.variables import BoundedNat
...
if __name__ == "__main__":
    ...
    for ctx, goals in context_goals.items():
        from tools.buchi_generation import generate_buchi
    ...
    component_library = ComponentsLibrary(name="subtypes")
