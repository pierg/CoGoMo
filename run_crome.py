...
from goals.operations import create_contextual_clusters, create_cgt, CGTFailException, pretty_cgt_exception, conjunction
from helper.tools import save_to_file

from mission_specification_2 import get_inputs
