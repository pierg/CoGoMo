...
from old_src.goals.cgtgoal import CGTGoal, GoalsLibrary
from typescogomo.formula import LTL
from old_src.goals import extract_unique_contexts_from_goals, \
...
def mapping(component_library: ComponentsLibrary,
    ...
    if len(hierarchy.values()) > 0:
        ...
        for i, (comp, comp_provided_by) in enumerate(hierarchy.items()):
            ...
            from old_src.goals import find_goal_with_name
